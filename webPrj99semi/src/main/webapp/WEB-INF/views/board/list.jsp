    ...
    <div id="wrap">
        ...
        <main>
            ...
            <c:if test="${pageVo.startPage gt 1 }">
            	<a href="${pageContext.request.contextPath}/board/list?pno=${pageVo.startPage-1}" }>이전</a>	            
            </c:if>
            ...
            <c:otherwise>
            	<a href="${pageContext.request.contextPath}/board/list?pno=${i}" }>${i }</a>            
            </c:otherwise>
            </c:choose>
            </c:forEach>
            <c:if test="${pageVo.endPage ne pageVo.maxPage }">
	            <a href="${pageContext.request.contextPath}/board/list?pno=${pageVo.endPage+1}" }>다음</a>	
            </c:if>
            </div>
        </main>
    </div>
